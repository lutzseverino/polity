...
import { useCastMotionVote } from "@/features/cast-motion-vote/api/cast-motion-vote-mutation";
import { cn } from "@/lib/utils";

type CastMotionVoteWorkflowProps = Readonly<{
  motion: Motion;
  polityId: string;
}>;

export function CastMotionVoteWorkflow({
  motion,
  polityId,
