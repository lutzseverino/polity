...
public final class PolityPermissions {
  ...
  public static final String POLITY_CREATE = "polity:create";
  public static final String POLITY_CREATE_AUTHORITY = CLIENT_ID + ":" + POLITY_CREATE;

  public static final String POLITY_RESOURCE = "polity:polity";

  public static final String HAS_POLITY_CREATE = "hasAuthority('" + POLITY_CREATE_AUTHORITY + "')";
